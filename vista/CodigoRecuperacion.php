        ...
        <header>
         ...
         <center> 
                <div class="contenedor1">
                    <form  action="<?= ENVIAR_CODIGO['url'] ?>" method="POST">
                        <div class="titulo"> <h2>Codigo de recuperación </h2></div>
                        <div class="form-group">
                            <label for="codigo_confirmacion">Ingrese su Codigo </label>
                            <input type="text" class="form-control" id="codigo_confirmacion" name="codigo_confirmacion">
                        </div>
